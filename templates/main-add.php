...
<form class="form form--add-lot container <?= $classname; ?>" action="add.php" method="post"
    ...
    <div class="form__item form__item--wide <?= $classname; ?>">
        ...
        <textarea id="message" name="message"
                  placeholder="Напишите описание лота"><?= isset($lot['message']); ?></textarea>
        <span class="form__error">Напишите описание лота Ошибка</span>
    </div>
    ...
    <div class="form__container-three">
        ...
        <div class="form__item form__item--small <?= $classname; ?>">
            ...
            <input id="lot-rate" type="text" name="lot-rate" placeholder="0" value="<?= isset($lot['lot-rate']); ?>">
        ...
        <div class="form__item form__item--small <?= $classname; ?>">
            ...
            <input id="lot-step" type="text" name="lot-step" placeholder="0" value="<?= isset($lot["lot-step"]); ?>">
        ...
        <div class="form__item <?= $classname; ?>">
            ...
            <input class="form__input-date" id="lot-date" type="text" name="lot-date"
                   placeholder="Введите дату в формате ГГГГ-ММ-ДД1" value="
        <?= isset($lot['lot-date']); ?>">
